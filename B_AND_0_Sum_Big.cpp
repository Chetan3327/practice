...
void solve(){
  ...
  // n * n * ... k times;
  // if n = 3 and k = 2
  // so  _ _  _ _  _ _ -> so to get largest sum with bitwise and 0 => 1 1 , 1 1 , 0 0 -> means [3, 3, 0]

  // so to get all comb we have to get the i th bit in one element as 0;
  // so we have n choices for setting ith bit 0
  // so n * n * ... kthimes, choices for k bits
